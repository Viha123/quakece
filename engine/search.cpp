...
int quiescense_search(int alpha, int beta, Board &board, int &quiesc_depth,
  ...
  if (score >= beta) {
    // if (quiesc_depth > 2) {
    //   std::cout << "Quiesce Depth (too good to be true move): " << quiesc_depth << std::endl;
    //   board.display();
    // }
    return beta;
  }
  ...
  if (moves.size() == 0) {
    if (kingInCheck(board, board.gameStateHistory.peek().turn)) {
      // if (quiesc_depth > 2) {
      //   std::cout << "Quiesce Depth (kingInCheck): " << quiesc_depth << std::endl;
      //   board.display();
      // }
      ...
      // if (quiesc_depth > 2) {
      //   std::cout << "Quiesce Depth (Stalemate): " << quiesc_depth << std::endl;
      //   board.display();
      // }
